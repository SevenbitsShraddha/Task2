...
export class ConfigurationApi {
    ...
    public async createPublicChatRoom (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: any;  }> {
        const localVarPath = this.basePath + '/v1/wallet/createPublicChatRoom';
     ...
     */
    public async saveWalletRecord (inlineObject65: InlineObject65, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: any;  }> {
        const localVarPath = this.basePath + '/v1/wallet';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        if (inlineObject65 === null || inlineObject65 === undefined) {
            throw new Error('Required parameter inlineObject65 was null or undefined when calling saveWalletRecord.');
        }
