...
export class MobileTerminalApi {
    ...
    public async fetchWalletItemFromMobileTerminal (itemID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: any;  }> {
        const localVarPath = this.basePath + '/v1/pos/mobile/item/{itemID}'
     ...
     * @param memberID 
     */
    public async findMemberByID (merchantID: string, memberID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Member;  }> {
        const localVarPath = this.basePath + '/v1/pos/mobile/member';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
        ...
        if (merchantID === null || merchantID === undefined) {
            throw new Error('Required parameter merchantID was null or undefined when calling findMemberByID.');
        }
    ...
    public async redeemWalletItemFromMobileTerminal (itemID: string, inlineObject49: InlineObject49, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: any;  }> {
        const localVarPath = this.basePath + '/v1/pos/mobile/item/redeem/{itemID}'
            .replace('{' + 'itemID' + '}', encodeURIComponent(String(itemID)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
