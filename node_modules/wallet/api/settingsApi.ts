...
export class SettingsApi {
    ...
    public async getActiveCampaigns (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<StaticVoucherCampaign>;  }> {
        const localVarPath = this.basePath + '/v1/settings/campaigns/active';
     ...
     */
    public async getVouchersCount (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InlineResponse2008;  }> {
        const localVarPath = this.basePath + '/v1/settings/vouchers/count';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        // give precedence to 'application/json'
