...
export class UtilitiesApi {
     ...
     */
    public async getPaymentPrefixes (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InlineResponse2006;  }> {
        const localVarPath = this.basePath + '/v1/payment/prefixes';
